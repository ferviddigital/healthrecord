  ...
  <div>
    ...
    <table v-if="people.length > 0" class="table-auto w-full">
      <thead class="text-left border-b-2">
        <tr>
          <th class="font-light text-xs uppercase text-gray-400 w-full p-2 pl-4 md:pl-6">Name</th>
          <th class="font-light text-xs uppercase text-gray-400 p-2">Sex</th>
          <th class="font-light text-xs uppercase text-gray-400 p-2">Age</th>
          <th colspan="2"></th>
        </tr>
      </thead>
      <tbody>
