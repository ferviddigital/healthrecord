...
<template>
  <div class="grid sm:grid-cols-[auto_200px]">
    <div>
      <div v-if="selectedMeasurement" class="grid grid-cols-[auto_min-content] bg-indigo-500 text-white rounded-xl mx-2 mt-2">
        <div class="grid grid-flow-col justify-start divide-x divide-indigo-400">
          <div class="p-2 px-4">
    ...
    <div class="grid grid-cols-2 sm:border-l sm:grid-cols-none sm:items-start sm:content-start divide-x sm:divide-x-0 divide-y mt-2 sm:mt-0">
