...
import { vitals, createBodyWeightVital, createHeartRateVital } from '@tore/vitals';
...
<template>
  <div>
    <HeaderTitleLeft title="Vitals" subtitle="Track Vitals and record new Measurements.">
      <template #right>
        <RouterLink
