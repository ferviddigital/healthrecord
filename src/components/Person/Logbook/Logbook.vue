...
<template>
  <div>
    <HeaderTitleLeft
      title="Logbook"
      subtitle="Create and view Notes and other activity."
    >
      <template #right>
        <RouterLink class="grid rounded-full bg-gray-300 hover:bg-gray-100 h-9 w-9 sm:h-10 sm:w-10 items-center justify-items-center" :to="{ name: 'PersonNoteCreate' }">
