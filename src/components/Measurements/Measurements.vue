...
<template>
  <div>
    ...
    >
      <hgroup class="grid grid-cols-[1fr_1fr_1fr] items-center">
        ...
        <div class="grid grid-flow-col gap-3 justify-self-end">
          <RouterLink class="grid rounded-full bg-gray-300 hover:bg-gray-100 h-9 w-9 sm:h-10 sm:w-10 items-center justify-items-center" :to="{ name: 'MeasurementCreate' }">
    ...
    <div class="m-4">
      <div v-if="measurements.length > 0" class="grid gap-3">
